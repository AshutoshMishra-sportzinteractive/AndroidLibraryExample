...
public class CustomDividerItemDecoration extends RecyclerView.ItemDecoration {
    ...
    private final int mFirstDividerIndex;
     ...
     */
    public CustomDividerItemDecoration(Context context, int orientation, int firstDividerIndex, int dividerPadding) {
        ...
        mFirstDividerIndex = firstDividerIndex;
    ...
    private void drawVertical(Canvas canvas, RecyclerView parent) {
        ...
        for (int i = mFirstDividerIndex; i < (childCount - 1); i++) {
